...
/* 3D HOME PAGE HERO SECTION */
.hero{padding:120px 0 50px;text-align:center;perspective:1000px}
.hero-badge{display:inline-flex;align-items:center;gap:8px;padding:6px 18px;border-radius:99px;
  background:var(--panel);border:1px solid var(--border-b);font-family:var(--fc);font-size:11px;
  font-weight:700;color:var(--terracotta);text-transform:uppercase;letter-spacing:1px;margin-bottom:24px;
  box-shadow:0 10px 30px rgba(194,65,12,0.08);transform:translateZ(10px)}
.hero h1{font-family:var(--fh);font-size:52px;font-weight:800;line-height:1.15;color:var(--text);
  max-width:920px;margin:0 auto 18px;letter-spacing:-0.5px}
...
.hstat-chip{background:var(--panel);border:1px solid var(--border);padding:10px 20px;border-radius:var(--r2);
  ...
  transform:translateZ(15px);transition:transform .2s ease}
.hstat-chip:hover{transform:translateZ(25px) translateY(-2px);border-color:var(--terracotta)}
...
/* 3D INTERACTIVE FABRIC CARDS SHOWCASE GALLERY (NEUTRAL UNREVEALED LABELS) */
...
.fab-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:28px}
.fab-card-3d{background:var(--panel);border:1px solid var(--border);border-radius:var(--r3);overflow:hidden;
...
.def-box{background:var(--panel);border:1px solid var(--border);border-radius:var(--r2);padding:26px;
  box-shadow:0 8px 30px rgba(0,0,0,0.03)}
.def-box h4{font-family:var(--fc);font-size:12px;font-weight:700;color:var(--terracotta);text-transform:uppercase;
  letter-spacing:1px;margin-bottom:14px}
.def-box ul{list-style:none;display:flex;flex-direction:column;gap:12px}
...
<div class="rel">
  ...
  <nav>
    <div class="nav-i">
      ...
      <div class="nav-cta">
        ...
        <a class="btn bg" href="#studio">🚀 Open Inspector</a>
      </div>
    </div>
  </nav>
  ...
  <section class="hero" id="home">
    <div class="con">
      <div class="hero-badge">✨ 3D NEURAL SURFACE VISION ENGINE</div>
      ...
      <div class="hero-ctas">
        <a class="btn bg" href="#studio">🚀 Launch AI Inspector</a>
      ...
      <div class="hero-stats">
        <div class="hstat-chip">
          <span class="val">&lt;8ms</span>
          <span class="lbl">Neural Latency</span>
        </div>
        <div class="hstat-chip">
          <span class="val">99.4%</span>
          <span class="lbl">Inspection Precision</span>
        </div>
        <div class="hstat-chip">
          <span class="val">ASTM D5430</span>
          <span class="lbl">4-Point Compliance</span>
        </div>
      </div>
    </div>
  </section>

  <!-- 3D INTERACTIVE FABRIC CARDS SHOWCASE GALLERY (NEUTRAL UNREVEALED SAMPLE LABELS) -->
  <section class="fabric-showcase" id="showcase">
    <div class="con">
      ...
      <div class="fab-grid">
        <!-- FABRIC 1: SAMPLE SWATCH 01 -->
        <div class="fab-card-3d" onmousemove="tilt3D(event, this)" onmouseleave="reset3D(this)">
          <div class="fab-img-wrap">
            <span class="fab-tag">Sample Swatch 01</span>
            <img src="/ref_stain.jpg" alt="Fabric Swatch 01">
          </div>
          <div class="fab-body">
            <h3>Fabric Swatch 01</h3>
            <button class="btn bgh" style="width:100%" onclick="document.querySelector('#studio').scrollIntoView({behavior:'smooth'});lp(null,'stain')">🔍 Inspect Swatch 01</button>
          </div>
        </div>

        <!-- FABRIC 2: SAMPLE SWATCH 02 -->
        <div class="fab-card-3d" onmousemove="tilt3D(event, this)" onmouseleave="reset3D(this)">
          <div class="fab-img-wrap">
            <span class="fab-tag">Sample Swatch 02</span>
            <img src="/ref_thread_error.jpg" alt="Fabric Swatch 02">
          </div>
          <div class="fab-body">
            <h3>Fabric Swatch 02</h3>
            <button class="btn bgh" style="width:100%" onclick="document.querySelector('#studio').scrollIntoView({behavior:'smooth'});lp(null,'thread')">🔍 Inspect Swatch 02</button>
          </div>
        </div>

        <!-- FABRIC 3: SAMPLE SWATCH 03 -->
        <div class="fab-card-3d" onmousemove="tilt3D(event, this)" onmouseleave="reset3D(this)">
          <div class="fab-img-wrap">
            <span class="fab-tag">Sample Swatch 03</span>
            <img src="/ref_hole.jpg" alt="Fabric Swatch 03">
          </div>
          <div class="fab-body">
            <h3>Fabric Swatch 03</h3>
            <button class="btn bgh" style="width:100%" onclick="document.querySelector('#studio').scrollIntoView({behavior:'smooth'});lp(null,'hole')">🔍 Inspect Swatch 03</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <header class="hdr" id="studio">
    <div class="con">
      <div class="hdr-flex">
        <div class="hdr-title">
          <h1>Live AI Fabric Defect Inspection Workbench</h1>
          <p>Real-Time Neural Surface Scanning & ASTM D5430 Quality Audit Workspace</p>
        </div>
